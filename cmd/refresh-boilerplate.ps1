...
$preserve = @('.git', 'src', '.env.development', '.env.test', '.env.live', 'project.cfg', 'Caddyfile', 'compose.yml', 'assets/db.sql')
...
$git = [ProjectConfigParse]::new().Require('remotes.boilerplate.url')
